...
class CollatzDatabase:
    ...
    def insert_analysis_result(self, analysis_type: str, range_start: int, 
                             range_end: int, total_sequences: int,
                             avg_sequence_length: float, max_sequence_length: int,
                             min_sequence_length: int, avg_max_value: float,

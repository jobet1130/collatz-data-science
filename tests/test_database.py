...
def test_functions_exist(db_connection):
    ...
    assert expected_functions.issubset(functions), f"Missing functions: {expected_functions - functions}"
...
def test_sequence_statistics_view(db_connection):
    ...
    with db_connection.cursor(cursor_factory=RealDictCursor) as cursor:
        ...
        expected_columns = {
            'total_sequences', 'min_starting_number', 'max_starting_number',
            'avg_sequence_length', 'min_sequence_length', 'max_sequence_length',
            'median_sequence_length', 'avg_max_value', 'min_max_value',
            'max_max_value', 'avg_total_steps', 'min_total_steps',
            'max_total_steps', 'sequences_with_stopping_time'
        }
